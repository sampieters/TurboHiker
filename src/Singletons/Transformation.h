...
public:
         ...
         * \param position: The position of the object in the world that needs to be converted to the position of the
         * object in teh window. \param size: The size of the object in the world that needs to be converted to te size
         * of the object in the window;
         */
