...
const sf::RectangleShape &Textbox::getBackground() const {
    return background;
}

void Textbox::setBackground(const sf::RectangleShape &background) {
...
void Textbox::typedOn(sf::Event input) {
    if (isSelected) {
        ...
        if (charTyped < 128) {
            ...
            else if(a.height >= background.getSize().y - (textbox.getCharacterSize())  && charTyped != DELETE_KEY) {}
