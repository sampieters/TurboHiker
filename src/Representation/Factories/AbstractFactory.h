    ...
    */
    ...
    public:
        ...
        */
         ...
         * \param entity: A shared pointer to an entity which is the object to follow with the camera (the player in this case).
         * \param score: A shared pointer to the score so that the camera can ask the score at each time.
