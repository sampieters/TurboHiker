...
std::shared_ptr<turbohiker::Entity> AbstractFactorySFML::Factory::CreateCamera(
    std::shared_ptr<turbohiker::Entity> entity, std::shared_ptr<turbohiker::Score> score) const
{
