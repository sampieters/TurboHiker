...
const std::shared_ptr<sf::SoundBuffer>& turbohikerSFML::Enemy::getBuffer() const { return buffer; }

void turbohikerSFML::Enemy::setBuffer(const std::shared_ptr<sf::SoundBuffer>& buffer) { Enemy::buffer = buffer; }

const std::shared_ptr<sf::Sound>& turbohikerSFML::Enemy::getSound() const { return sound; }

void turbohikerSFML::Enemy::setSound(const std::shared_ptr<sf::Sound>& sound) { Enemy::sound = sound; }
