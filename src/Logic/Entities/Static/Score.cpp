...
turbohiker::Score::Score() { score = 0; }
...
unsigned int turbohiker::Score::getScore() const { return score; }

void turbohiker::Score::setScore(unsigned int score) { Score::score = score; }

void turbohiker::Score::addFinisher() { finished += 1; }

unsigned int turbohiker::Score::getFinished() const { return finished; }
