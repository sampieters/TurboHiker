...
float turbohiker::DynamicEntity::getSpeed() const { return speed; }

void turbohiker::DynamicEntity::setSpeed(float speed) { DynamicEntity::speed = speed; }
...
void turbohiker::DynamicEntity::update(double elapsedTime) { this->MoveUp(elapsedTime); }
...
const std::string& turbohiker::DynamicEntity::getYelling() const { return yelling; }

void turbohiker::DynamicEntity::setYelling(const std::string& yelling) { DynamicEntity::yelling = yelling; }

bool turbohiker::DynamicEntity::isYell() const { return yell; }
...
void turbohiker::DynamicEntity::setLane(const std::shared_ptr<Lane>& lane) { DynamicEntity::lane = lane; }
