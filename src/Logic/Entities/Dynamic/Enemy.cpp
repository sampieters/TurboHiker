...
float turbohiker::Enemy::getMoveChance() const {
    return MoveChance;
}

void turbohiker::Enemy::setMoveChance(float moveChance) {
    MoveChance = moveChance;
}

unsigned int turbohiker::Enemy::getScaredMeter() const {
    return scared_meter;
}

void turbohiker::Enemy::setScaredMeter(unsigned int scaredMeter) {
    scared_meter = scaredMeter;
}

Response turbohiker::Enemy::getResponse() const {
    return response;
}

void turbohiker::Enemy::setResponse(Response response) {
    Enemy::response = response;
}
